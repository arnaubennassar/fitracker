...
export const seedExerciseMedia: SeedExerciseMedia[] = [
  {
    ...
    type: "image",
    url: "/media/exercises/goblet-squat/front.png",
    mimeType: "image/png",
    durationSeconds: null,
    thumbnailUrl: "/media/exercises/goblet-squat/front-thumb.png",
    sortOrder: 1,
    createdAt: seedTimestamps.createdAt,
  },
  {
    id: "media_goblet_squat_video",
    exerciseId: "exercise_goblet_squat",
    type: "video",
    url: "/media/exercises/goblet-squat/demo.mp4",
    mimeType: "video/mp4",
    durationSeconds: 42,
    thumbnailUrl: "/media/exercises/goblet-squat/demo-thumb.png",
    sortOrder: 2,
    createdAt: seedTimestamps.createdAt,
  },
  {
    id: "media_bike_intervals_video",
    exerciseId: "exercise_bike_intervals",
    type: "video",
    url: "/media/exercises/bike-intervals/demo.mp4",
    mimeType: "video/mp4",
    durationSeconds: 58,
    thumbnailUrl: "/media/exercises/bike-intervals/demo-thumb.png",
    sortOrder: 1,
    createdAt: seedTimestamps.createdAt,
  },
];
